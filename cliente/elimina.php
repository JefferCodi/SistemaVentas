...
<body>
	...
	if (isset($_POST['btnMantenimiento'])) {
		...
		if ($boton == "AGREGAR NUEVO CLIENTE") {
			...
			$objCli->setCodigo($_POST['txtCodigo']);
			$objNeg->elimina($objCli->getCodigo());		
		}
	}
	...
	<form method="POST" class="col s12 m8 l4 offset-m2 offset-l4">
		<div class="card">
			...
			<div class="card-action center-align">
				<button class="waves-effect waves-light btn red" type="submit" name="btnMantenimiento" value="ELIMINA">elimina</button>
			</div>
		</div>
	</form>
</div>
